...
def sim_frame_to_msm(coord=np.array([0, 0, 0])):
    """
    Converts : x, y, z (simulation frame) --> x_MSM, y_MSM, z_MSM (MSM : shifted MSO)
    """
    x = -coord[0]
    y = -coord[1]
    z = coord[2] - 479e3 / RM
...
def msm_to_sim_frame(coord=np.array([0, 0, 0])):
    """
    Converts : x_MSM, y_MSM, z_MSM (MSM : shifted MSO) --> x, y, z (simulation frame)
    """
    x = -coord[0]
    y = -coord[1]
    z = coord[2] + 479e3 / RM
