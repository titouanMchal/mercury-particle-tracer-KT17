...
import numpy as np
import KT_field as kt
import functions as f

# Test particle tracing code
# Uses KT17 magnetic field model and a Volland-Stern distribution for the electrostatic potential
...
# Required python packages: numpy, scipy, matplotlib, KT17
...
if plot_trajectory:
    ...
    fig, ax = kt.slice_B_KT(projection="XY")
